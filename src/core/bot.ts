...
export class DigitalPersonalityBot {
  ...
  private generateMediaResponse(msg: TelegramBot.Message, userName: string): string | null {
    const responses = {
      ...
      voice: [
        "Слышу, слышу",
        "Голосовуху прислал, серьезные дела видать",
        "Не могу послушать сейчас, но принял к сведению",
        "Что там говоришь?",
        "Голосом общаемся, как в старые добрые"
      ],
      video_note: [
        "Кружочек записал, важные новости?",
        "Видосик глянул",
        "Что там показываешь?",
        "Интересно",
