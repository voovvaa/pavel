...
// Устанавливаем правильные права доступа к файлу базы данных
if (isProduction) {
  try {
    const fs = require('fs');
    fs.chmodSync(dbPath, 0o664); // rw-rw-r--
    console.log('📝 Установлены права доступа к базе данных: 664');
  } catch (error) {
    console.warn('⚠️ Не удалось установить права доступа:', error.message);
  }
}
